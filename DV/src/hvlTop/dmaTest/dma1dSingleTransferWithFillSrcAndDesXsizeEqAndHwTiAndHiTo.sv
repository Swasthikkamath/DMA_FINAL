`ifndef DMA1D_SINGLE_TRANSFER_WITH_FILL_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED
`define DMA1D_SINGLE_TRANSFER_WITH_FILL_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED

class dma1dSingleTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dSingleTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dSingleTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dSingleTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo :: new(string name ="dma1dSingleTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dSingleTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dSingleTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo::run_phase(uvm_phase phase);
