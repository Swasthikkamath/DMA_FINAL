`ifndef DMA1D_BLOCK_TRANSFER_WITH_WRAP_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_WRAP_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithWrapSrcGreaterThanDesXsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithWrapSrcGreaterThanDesXsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithWrapSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithWrapSrcGreaterThanDesXsizeAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithWrapSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dBlockTransferWithWrapSrcGreaterThanDesXsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  // Trigger SRC TYPE
  topEnvConfigHandle.allChannelConfig[0][0].CH_SRCTRIGINCFG.SRCTRIGINTYPE = 10;
...
task dma1dBlockTransferWithWrapSrcGreaterThanDesXsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
