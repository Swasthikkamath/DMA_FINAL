`ifndef DMA1D_SINGLE_TRANSFER_WITH_FILL_SRC_SMALLER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED
`define DMA1D_SINGLE_TRANSFER_WITH_FILL_SRC_SMALLER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED

class dma1dSingleTransferWithFillSrcSmallerThanDesXsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dSingleTransferWithFillSrcSmallerThanDesXsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dSingleTransferWithFillSrcSmallerThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);

endclass

function dma1dSingleTransferWithFillSrcSmallerThanDesXsizeAndHwTiAndHiTo :: new(string name ="dma1dSingleTransferWithFillSrcSmallerThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dSingleTransferWithFillSrcSmallerThanDesXsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dSingleTransferWithFillSrcSmallerThanDesXsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
