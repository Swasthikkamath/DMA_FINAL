`ifndef DMA1D_BLOCK_TRANSFER_WITH_WRAP_SRC_XSIZE_GREATER_THAN_0_AND_DES_XSIZE_EQ_0_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_WRAP_SRC_XSIZE_GREATER_THAN_0_AND_DES_XSIZE_EQ_0_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithWrapSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithWrapSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo)
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithWrapSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithWrapSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithWrapSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dBlockTransferWithWrapSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dBlockTransferWithWrapSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo::run_phase(uvm_phase phase);
