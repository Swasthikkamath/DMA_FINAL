`ifndef DMA1D_BLOCK_TRANSFER_WITH_SRC_XSIZE_EQ0_DEST_XSIZE_GT0_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_SRC_XSIZE_EQ0_DEST_XSIZE_GT0_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dBlockTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dBlockTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo::run_phase(uvm_phase phase);
