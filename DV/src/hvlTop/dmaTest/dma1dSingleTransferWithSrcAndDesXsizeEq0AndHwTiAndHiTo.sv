`ifndef DMA1D_SINGLE_TRANSFER_WITH_SRC_AND_DEST_XSIZE_EQ0_AND_HWTI_HITO_INCLUDED
  `define DMA1D_SINGLE_TRANSFER_WITH_SRC_AND_DEST_XSIZE_EQ0_AND_HWTI_HITO_INCLUDED

  class dma1dSingleTransferWithSrcAndDesXsizeEq0AndHwTiAndHiTo extends dmaBaseTest;

    `uvm_component_utils(dma1dSingleTransferWithSrcAndDesXsizeEq0AndHwTiAndHiTo);
    dma1DVirtualSeq dma1DVirtualSeqHandle;
    extern function new(string name ="dma1dSingleTransferWithSrcAndDesXsizeEq0AndHwTiAndHiTo",uvm_component parent = null);
    extern virtual function void build_phase(uvm_phase phase);
    extern virtual task run_phase(uvm_phase phase);

  endclass

  function dma1dSingleTransferWithSrcAndDesXsizeEq0AndHwTiAndHiTo :: new(string name ="dma1dSingleTransferWithSrcAndDesXsizeEq0AndHwTiAndHiTo",uvm_component parent = null);
    super.new(name,parent);
  endfunction


  function void dma1dSingleTransferWithSrcAndDesXsizeEq0AndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  task dma1dSingleTransferWithSrcAndDesXsizeEq0AndHwTiAndHiTo::run_phase(uvm_phase phase);
