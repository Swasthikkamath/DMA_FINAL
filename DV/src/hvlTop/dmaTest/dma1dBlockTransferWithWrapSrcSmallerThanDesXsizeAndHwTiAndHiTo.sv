`ifndef DMA1D_BLOCK_TRANSFER_WITH_WRAP_SRC_SMALLER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_WRAP_SRC_SMALLER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithWrapSrcSmallerThanDesXsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithWrapSrcSmallerThanDesXsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithWrapSrcSmallerThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithWrapSrcSmallerThanDesXsizeAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithWrapSrcSmallerThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dBlockTransferWithWrapSrcSmallerThanDesXsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dBlockTransferWithWrapSrcSmallerThanDesXsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
