`ifndef DMA2D_BLOCK_TRANSFER_WITH_XCONTINUE_YCONTINUE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XCONTINUE_YCONTINUE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXContinueYContinueAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXContinueYContinueAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXContinueYContinueAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXContinueYContinueAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXContinueYContinueAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXContinueYContinueAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //==================================================================
  // CHANNEL 0 : 2D BLOCK TRANSFER  ->  XTYPE = X_CONTINUE , YTYPE = Y_CONTINUE
  //==================================================================
  ...
  //==================================================================
  // CHANNEL 1 : 2D BLOCK TRANSFER  ->  XTYPE = X_CONTINUE , YTYPE = Y_CONTINUE
  //==================================================================
...
task dma2dBlockTransferWithXContinueYContinueAndHwTiAndHiTo::run_phase(uvm_phase phase);
