`ifndef DMA2D_BLOCK_TRANSFER_WITH_XFILL_SRCLT_DESXSIZE_YFILL_SRCGT_DESYSIZE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XFILL_SRCLT_DESXSIZE_YFILL_SRCGT_DESYSIZE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcGreaterDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcGreaterDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcGreaterDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcGreaterDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcGreaterDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcGreaterDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcGreaterDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
