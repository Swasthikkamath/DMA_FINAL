`ifndef DMA2D_BLOCK_TRANSFER_WITH_XCONTINUE_SRCLT_DESXSIZE_YCONTINUE_SRCLT_DESYSIZE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XCONTINUE_SRCLT_DESXSIZE_YCONTINUE_SRCLT_DESYSIZE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXContinueSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXContinueSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXContinueSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXContinueSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXContinueSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXContinueSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithXContinueSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
