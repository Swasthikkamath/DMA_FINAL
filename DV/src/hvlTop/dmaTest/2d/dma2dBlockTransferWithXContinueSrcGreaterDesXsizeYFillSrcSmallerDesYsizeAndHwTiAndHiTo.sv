`ifndef DMA2D_BLOCK_TRANSFER_WITH_XCONTINUE_SRCGT_DESXSIZE_YFILL_SRCLT_DESYSIZE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XCONTINUE_SRCGT_DESXSIZE_YFILL_SRCLT_DESYSIZE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXContinueSrcGreaterDesXsizeYFillSrcSmallerDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXContinueSrcGreaterDesXsizeYFillSrcSmallerDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXContinueSrcGreaterDesXsizeYFillSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXContinueSrcGreaterDesXsizeYFillSrcSmallerDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXContinueSrcGreaterDesXsizeYFillSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXContinueSrcGreaterDesXsizeYFillSrcSmallerDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithXContinueSrcGreaterDesXsizeYFillSrcSmallerDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
