`ifndef DMA2D_BLOCK_TRANSFER_WITH_XWRAP_SRCEQ_DESXSIZE_YWRAP_SRCEQ_DESYSIZE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XWRAP_SRCEQ_DESXSIZE_YWRAP_SRCEQ_DESYSIZE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXWrapSrcEqualDesXsizeYWrapSrcEqualDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXWrapSrcEqualDesXsizeYWrapSrcEqualDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXWrapSrcEqualDesXsizeYWrapSrcEqualDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXWrapSrcEqualDesXsizeYWrapSrcEqualDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXWrapSrcEqualDesXsizeYWrapSrcEqualDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXWrapSrcEqualDesXsizeYWrapSrcEqualDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithXWrapSrcEqualDesXsizeYWrapSrcEqualDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
