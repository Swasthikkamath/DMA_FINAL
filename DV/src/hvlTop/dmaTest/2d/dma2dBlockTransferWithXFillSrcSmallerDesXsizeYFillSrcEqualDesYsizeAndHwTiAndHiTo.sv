`ifndef DMA2D_BLOCK_TRANSFER_WITH_XFILL_SRCLT_DESXSIZE_YFILL_SRCEQ_DESYSIZE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XFILL_SRCLT_DESXSIZE_YFILL_SRCEQ_DESYSIZE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcEqualDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcEqualDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcEqualDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcEqualDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcEqualDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcEqualDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithXFillSrcSmallerDesXsizeYFillSrcEqualDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
