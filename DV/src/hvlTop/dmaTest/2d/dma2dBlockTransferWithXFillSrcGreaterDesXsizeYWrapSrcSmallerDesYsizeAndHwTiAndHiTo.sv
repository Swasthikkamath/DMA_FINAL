`ifndef DMA2D_BLOCK_TRANSFER_WITH_XFILL_SRCGT_DESXSIZE_YWRAP_SRCLT_DESYSIZE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XFILL_SRCGT_DESXSIZE_YWRAP_SRCLT_DESYSIZE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXFillSrcGreaterDesXsizeYWrapSrcSmallerDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXFillSrcGreaterDesXsizeYWrapSrcSmallerDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXFillSrcGreaterDesXsizeYWrapSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXFillSrcGreaterDesXsizeYWrapSrcSmallerDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXFillSrcGreaterDesXsizeYWrapSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXFillSrcGreaterDesXsizeYWrapSrcSmallerDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithXFillSrcGreaterDesXsizeYWrapSrcSmallerDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
