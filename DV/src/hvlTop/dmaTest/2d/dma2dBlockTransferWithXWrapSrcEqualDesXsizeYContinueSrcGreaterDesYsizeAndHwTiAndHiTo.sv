`ifndef DMA2D_BLOCK_TRANSFER_WITH_XWRAP_SRCEQ_DESXSIZE_YCONTINUE_SRCGT_DESYSIZE_AND_HWTI_HITO_INCLUDED
`define DMA2D_BLOCK_TRANSFER_WITH_XWRAP_SRCEQ_DESXSIZE_YCONTINUE_SRCGT_DESYSIZE_AND_HWTI_HITO_INCLUDED

class dma2dBlockTransferWithXWrapSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithXWrapSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithXWrapSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithXWrapSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithXWrapSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithXWrapSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithXWrapSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
