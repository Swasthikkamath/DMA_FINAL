`ifndef DMA1D_SINGLE_TRANSFER_WITH_FILL_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED
`define DMA1D_SINGLE_TRANSFER_WITH_FILL_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED

class dma1dSingleTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dSingleTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dSingleTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);

endclass

function dma1dSingleTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo :: new(string name ="dma1dSingleTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dSingleTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dSingleTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
