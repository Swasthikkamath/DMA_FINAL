`ifndef DMA1D_BLOCK_TRANSFER_WITH_CONTINUE_SRC_SMALLER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_CONTINUE_SRC_SMALLER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithContinueSrcSmallerThanDesXsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithContinueSrcSmallerThanDesXsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithContinueSrcSmallerThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithContinueSrcSmallerThanDesXsizeAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithContinueSrcSmallerThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dBlockTransferWithContinueSrcSmallerThanDesXsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dBlockTransferWithContinueSrcSmallerThanDesXsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
