`ifndef DMA1D_SINGLE_TRANSFER_WITH_CONTINUE_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED
`define DMA1D_SINGLE_TRANSFER_WITH_CONTINUE_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED

class dma1dSingleTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dSingleTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dSingleTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dSingleTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo :: new(string name ="dma1dSingleTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dSingleTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma1dSingleTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo::run_phase(uvm_phase phase);
