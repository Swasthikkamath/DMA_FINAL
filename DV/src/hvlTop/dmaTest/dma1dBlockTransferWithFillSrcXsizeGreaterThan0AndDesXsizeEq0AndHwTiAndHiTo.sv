`ifndef DMA1D_BLOCK_TRANSFER_WITH_FILL_SRC_XSIZE_GREATER_THAN_0_AND_DES_XSIZE_EQ_0_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_FILL_SRC_XSIZE_GREATER_THAN_0_AND_DES_XSIZE_EQ_0_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithFillSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithFillSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithFillSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithFillSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithFillSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dBlockTransferWithFillSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  topEnvConfigHandle.allChannelConfig[0][0].CH_SRCTRIGINCFG.SRCTRIGINBLKSIZE = 'd10;
  ...
  topEnvConfigHandle.allChannelConfig[0][0].CH_DESTRIGINCFG.DESTRIGINBLKSIZE = 'd10;
  ...
  // CH_XSIZE = 32'H 0000_0005
  topEnvConfigHandle.allChannelConfig[0][0].CH_XSIZE = 'h 0000_0005;
...
task dma1dBlockTransferWithFillSrcXsizeGreaterThan0AndDesXsizeEq0AndHwTiAndHiTo::run_phase(uvm_phase phase);
