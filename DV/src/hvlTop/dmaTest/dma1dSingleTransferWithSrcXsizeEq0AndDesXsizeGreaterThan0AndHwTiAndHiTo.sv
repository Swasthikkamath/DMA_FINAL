`ifndef DMA1D_SINGLE_TRANSFER_WITH_SRC_XSIZE_EQ0_DEST_XSIZE_GT0_AND_HWTI_HITO_INCLUDED
  `define DMA1D_SINGLE_TRANSFER_WITH_SRC_XSIZE_EQ0_DEST_XSIZE_GT0_AND_HWTI_HITO_INCLUDED

  class dma1dSingleTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo extends dmaBaseTest;

    `uvm_component_utils(dma1dSingleTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo);
    dma1DVirtualSeq dma1DVirtualSeqHandle;
    extern function new(string name ="dma1dSingleTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo",uvm_component parent = null);
    extern virtual function void build_phase(uvm_phase phase);
    extern virtual task run_phase(uvm_phase phase);

  endclass

  function dma1dSingleTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo :: new(string name ="dma1dSingleTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo",uvm_component parent = null);
    super.new(name,parent);
  endfunction


  function void dma1dSingleTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo::build_phase(uvm_phase phase);
    ...
    // CH_XSIZE = 32'H 0010_0000

    topEnvConfigHandle.allChannelConfig[0][0].CH_XSIZE = 'h 0010_0000;
  ...
  task dma1dSingleTransferWithSrcXsizeEq0AndDesXsizeGreaterThan0AndHwTiAndHiTo::run_phase(uvm_phase phase);
