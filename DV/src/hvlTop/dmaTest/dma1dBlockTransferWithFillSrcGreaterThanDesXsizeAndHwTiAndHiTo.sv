`ifndef DMA1D_BLOCK_TRANSFER_WITH_FILL_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_FILL_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction

function void dma1dBlockTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  // CH_XSIZE = 32'H 0005_0010
  topEnvConfigHandle.allChannelConfig[0][0].CH_XSIZE = 'h 0005_0010;
...
task dma1dBlockTransferWithFillSrcGreaterThanDesXsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
