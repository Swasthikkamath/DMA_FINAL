`ifndef DMA1D_BLOCK_TRANSFER_WITH_CONTINUE_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_CONTINUE_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  topEnvConfigHandle.allChannelConfig[0][0].CH_TMPLTCFG.SRCTMPLTSIZE=3;
...
task dma1dBlockTransferWithContinueSrcAndDesXsizeEqAndHwTiAndHiTo::run_phase(uvm_phase phase);
