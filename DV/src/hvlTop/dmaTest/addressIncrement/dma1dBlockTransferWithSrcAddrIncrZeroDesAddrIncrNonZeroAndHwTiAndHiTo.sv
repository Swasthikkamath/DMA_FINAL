`ifndef DMA1DBLOCKTRANSFERWITHSRCADDRINCRZERODESADDRINCRNONZEROANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCADDRINCRZERODESADDRINCRNONZEROANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAddrIncrZeroDesAddrIncrNonZeroAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAddrIncrZeroDesAddrIncrNonZeroAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAddrIncrZeroDesAddrIncrNonZeroAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAddrIncrZeroDesAddrIncrNonZeroAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAddrIncrZeroDesAddrIncrNonZeroAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAddrIncrZeroDesAddrIncrNonZeroAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 00040000;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 00040000;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 00040000;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 00040000;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 00040000;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 00040000;
...
task dma1dBlockTransferWithSrcAddrIncrZeroDesAddrIncrNonZeroAndHwTiAndHiTo::run_phase(uvm_phase phase);
