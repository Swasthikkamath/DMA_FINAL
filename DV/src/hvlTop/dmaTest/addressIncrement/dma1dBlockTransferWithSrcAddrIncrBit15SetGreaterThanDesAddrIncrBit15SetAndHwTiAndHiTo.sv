`ifndef DMA1DBLOCKTRANSFERWITHSRCADDRINCRBIT15SETGREATERTHANDESADDRINCRBIT15SETANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCADDRINCRBIT15SETGREATERTHANDESADDRINCRBIT15SETANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAddrIncrBit15SetGreaterThanDesAddrIncrBit15SetAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAddrIncrBit15SetGreaterThanDesAddrIncrBit15SetAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAddrIncrBit15SetGreaterThanDesAddrIncrBit15SetAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAddrIncrBit15SetGreaterThanDesAddrIncrBit15SetAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAddrIncrBit15SetGreaterThanDesAddrIncrBit15SetAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAddrIncrBit15SetGreaterThanDesAddrIncrBit15SetAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  // condition SRCXSIZE == DESTXSIZE
  // CH_XSIZE = 32'H 0005_0005
  topEnvConfigHandle.allChannelConfig[0][0].CH_YSIZE = 'h 000A0003;
  ...
  //CH_XADDRINC = 'h 80018008;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 80018008;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 80018008;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 80018008;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 80018008;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 80018008;
...
task dma1dBlockTransferWithSrcAddrIncrBit15SetGreaterThanDesAddrIncrBit15SetAndHwTiAndHiTo::run_phase(uvm_phase phase);
  ...
  /*pollingSeq = dmaPollingVirtualSeq :: type_id :: create("pollingSeq");
  pollingSeq.topEnvConfigHandle = topEnvConfigHandle;
  pollingSeq.start(topEnvHandle.topEnvVirtualSequencerHandle);*/
