`ifndef DMA1DBLOCKTRANSFERWITHSRCADDRINCRBIT15SETSMALLERTHANDESADDRINCRBIT15SETANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCADDRINCRBIT15SETSMALLERTHANDESADDRINCRBIT15SETANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAddrIncrBit15SetSmallerThanDesAddrIncrBit15SetAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAddrIncrBit15SetSmallerThanDesAddrIncrBit15SetAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAddrIncrBit15SetSmallerThanDesAddrIncrBit15SetAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAddrIncrBit15SetSmallerThanDesAddrIncrBit15SetAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAddrIncrBit15SetSmallerThanDesAddrIncrBit15SetAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAddrIncrBit15SetSmallerThanDesAddrIncrBit15SetAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 80088001;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 80088001;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 80088001;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 80088001;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 80088001;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 80088001;
...
task dma1dBlockTransferWithSrcAddrIncrBit15SetSmallerThanDesAddrIncrBit15SetAndHwTiAndHiTo::run_phase(uvm_phase phase);
