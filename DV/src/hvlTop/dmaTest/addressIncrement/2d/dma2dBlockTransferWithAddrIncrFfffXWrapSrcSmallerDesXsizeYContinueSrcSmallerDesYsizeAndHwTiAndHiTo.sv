`ifndef DMA2DBLOCKTRANSFERWITHADDRINCRFFFFXWRAPSRCSMALLERDESXSIZEYCONTINUESRCSMALLERDESYSIZEANDHWTIANDHITO_INCLUDED
`define DMA2DBLOCKTRANSFERWITHADDRINCRFFFFXWRAPSRCSMALLERDESXSIZEYCONTINUESRCSMALLERDESYSIZEANDHWTIANDHITO_INCLUDED

class dma2dBlockTransferWithAddrIncrFfffXWrapSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithAddrIncrFfffXWrapSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithAddrIncrFfffXWrapSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithAddrIncrFfffXWrapSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithAddrIncrFfffXWrapSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithAddrIncrFfffXWrapSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
...
task dma2dBlockTransferWithAddrIncrFfffXWrapSrcSmallerDesXsizeYContinueSrcSmallerDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
