`ifndef DMA2DBLOCKTRANSFERWITHADDRINCRFFFFXFILLSRCEQUALDESXSIZEYCONTINUESRCGREATERDESYSIZEANDHWTIANDHITO_INCLUDED
`define DMA2DBLOCKTRANSFERWITHADDRINCRFFFFXFILLSRCEQUALDESXSIZEYCONTINUESRCGREATERDESYSIZEANDHWTIANDHITO_INCLUDED

class dma2dBlockTransferWithAddrIncrFfffXFillSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma2dBlockTransferWithAddrIncrFfffXFillSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq;
  extern function new(string name ="dma2dBlockTransferWithAddrIncrFfffXFillSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma2dBlockTransferWithAddrIncrFfffXFillSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo :: new(string name ="dma2dBlockTransferWithAddrIncrFfffXFillSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma2dBlockTransferWithAddrIncrFfffXFillSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //   XTYPE = X_FILL , YTYPE = Y_CONTINUE
  //   X SIZE : SRCXSIZE == DESXSIZE   (CH_XSIZE = 'h000A000A -> DESXSIZE[31:16], SRCXSIZE[15:0])
  //   Y SIZE : SRCYSIZE > DESYSIZE   (CH_YSIZE = 'h00030005 -> DESYSIZE[31:16], SRCYSIZE[15:0])
  //==================================================================
  ...
  // XTYPE = X_FILL
  topEnvConfigHandle.allChannelConfig[0][0].CH_CTRL.XTYPE = X_FILL;
  ...
  topEnvConfigHandle.allChannelConfig[0][0].CH_YSIZE = 'h 00030005;
  ...
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h FFFFFFFF;
  ...
  // XTYPE = X_FILL
  topEnvConfigHandle.allChannelConfig[1][0].CH_CTRL.XTYPE = X_FILL;
  ...
  topEnvConfigHandle.allChannelConfig[1][0].CH_YSIZE = 'h 00030005;
  ...
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h FFFFFFFF;
...
task dma2dBlockTransferWithAddrIncrFfffXFillSrcEqualDesXsizeYContinueSrcGreaterDesYsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
