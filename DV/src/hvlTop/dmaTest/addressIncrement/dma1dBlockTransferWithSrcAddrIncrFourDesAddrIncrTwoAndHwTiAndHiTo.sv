`ifndef DMA1DBLOCKTRANSFERWITHSRCADDRINCRFOURDESADDRINCRTWOANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCADDRINCRFOURDESADDRINCRTWOANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAddrIncrFourDesAddrIncrTwoAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAddrIncrFourDesAddrIncrTwoAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAddrIncrFourDesAddrIncrTwoAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAddrIncrFourDesAddrIncrTwoAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAddrIncrFourDesAddrIncrTwoAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAddrIncrFourDesAddrIncrTwoAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 00020004;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 00020004;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 00020004;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 00020004;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 00020004;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 00020004;
...
task dma1dBlockTransferWithSrcAddrIncrFourDesAddrIncrTwoAndHwTiAndHiTo::run_phase(uvm_phase phase);
