`ifndef DMA1DBLOCKTRANSFERWITHSRCADDRINCREQUALDESADDRINCRANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCADDRINCREQUALDESADDRINCRANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAddrIncrEqualDesAddrIncrAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAddrIncrEqualDesAddrIncrAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAddrIncrEqualDesAddrIncrAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAddrIncrEqualDesAddrIncrAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAddrIncrEqualDesAddrIncrAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAddrIncrEqualDesAddrIncrAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 00020002;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 00020002;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 00020002;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 00020002;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 00020002;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 00020002;
...
task dma1dBlockTransferWithSrcAddrIncrEqualDesAddrIncrAndHwTiAndHiTo::run_phase(uvm_phase phase);
