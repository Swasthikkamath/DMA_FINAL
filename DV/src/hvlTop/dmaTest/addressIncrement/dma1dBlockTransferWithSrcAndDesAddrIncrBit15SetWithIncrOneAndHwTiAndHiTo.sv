`ifndef DMA1DBLOCKTRANSFERWITHSRCANDDESADDRINCRBIT15SETWITHINCRONEANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCANDDESADDRINCRBIT15SETWITHINCRONEANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAndDesAddrIncrBit15SetWithIncrOneAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAndDesAddrIncrBit15SetWithIncrOneAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAndDesAddrIncrBit15SetWithIncrOneAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAndDesAddrIncrBit15SetWithIncrOneAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAndDesAddrIncrBit15SetWithIncrOneAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAndDesAddrIncrBit15SetWithIncrOneAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 80018001;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 80018001;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 80018001;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 80018001;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 80018001;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 80018001;
...
task dma1dBlockTransferWithSrcAndDesAddrIncrBit15SetWithIncrOneAndHwTiAndHiTo::run_phase(uvm_phase phase);
