`ifndef DMA1DBLOCKTRANSFERWITHSRCADDRINCRTWODESADDRINCRFOURANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCADDRINCRTWODESADDRINCRFOURANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAddrIncrTwoDesAddrIncrFourAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAddrIncrTwoDesAddrIncrFourAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAddrIncrTwoDesAddrIncrFourAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAddrIncrTwoDesAddrIncrFourAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAddrIncrTwoDesAddrIncrFourAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAddrIncrTwoDesAddrIncrFourAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 00040002;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 00040002;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 00040002;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 00040002;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 00040002;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 00040002;
...
task dma1dBlockTransferWithSrcAddrIncrTwoDesAddrIncrFourAndHwTiAndHiTo::run_phase(uvm_phase phase);
