`ifndef DMA1DBLOCKTRANSFERWITHSRCANDDESADDRINCREQUALSIXTEENANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCANDDESADDRINCREQUALSIXTEENANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAndDesAddrIncrEqualSixteenAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAndDesAddrIncrEqualSixteenAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAndDesAddrIncrEqualSixteenAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAndDesAddrIncrEqualSixteenAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAndDesAddrIncrEqualSixteenAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAndDesAddrIncrEqualSixteenAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 00100010;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 00100010;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 00100010;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 00100010;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 00100010;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 00100010;
...
task dma1dBlockTransferWithSrcAndDesAddrIncrEqualSixteenAndHwTiAndHiTo::run_phase(uvm_phase phase);
