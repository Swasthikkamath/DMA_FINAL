`ifndef DMA1DBLOCKTRANSFERWITHSRCADDRINCRNONZERODESADDRINCRZEROANDHWTIANDHITO_INCLUDED
`define DMA1DBLOCKTRANSFERWITHSRCADDRINCRNONZERODESADDRINCRZEROANDHWTIANDHITO_INCLUDED

class dma1dBlockTransferWithSrcAddrIncrNonZeroDesAddrIncrZeroAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithSrcAddrIncrNonZeroDesAddrIncrZeroAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  dmaPollingVirtualSeq pollingSeq; 
  extern function new(string name ="dma1dBlockTransferWithSrcAddrIncrNonZeroDesAddrIncrZeroAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithSrcAddrIncrNonZeroDesAddrIncrZeroAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithSrcAddrIncrNonZeroDesAddrIncrZeroAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithSrcAddrIncrNonZeroDesAddrIncrZeroAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  //CH_XADDRINC = 'h 00000004;
  topEnvConfigHandle.allChannelConfig[0][0].CH_XADDRINC='h 00000004;
...
//  topEnvConfigHandle.addressIfLinking[0][1] = 3000;
  ...
  //CH_XADDRINC = 'h 00000004;
  topEnvConfigHandle.allChannelConfig[1][0].CH_XADDRINC='h 00000004;
 ...
 /* // Disable 2D
  ...
  //CH_XADDRINC = 'h 00000004;
  topEnvConfigHandle.allChannelConfig[0][1].CH_XADDRINC='h 00000004;
...
task dma1dBlockTransferWithSrcAddrIncrNonZeroDesAddrIncrZeroAndHwTiAndHiTo::run_phase(uvm_phase phase);
