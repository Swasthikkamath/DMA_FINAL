`ifndef DMA1D_BLOCK_TRANSFER_WITH_CONTINUE_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED
	`define DMA1D_BLOCK_TRANSFER_WITH_CONTINUE_SRC_GREATER_THAN_DES_XSIZE_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithContinueSrcGreaterThanDesXsizeAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithContinueSrcGreaterThanDesXsizeAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithContinueSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  extern virtual function void build_phase(uvm_phase phase);
  extern virtual task run_phase(uvm_phase phase);
endclass

function dma1dBlockTransferWithContinueSrcGreaterThanDesXsizeAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithContinueSrcGreaterThanDesXsizeAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithContinueSrcGreaterThanDesXsizeAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  // INTERUPT CMD
  topEnvConfigHandle.allChannelConfig[0][1].CH_INTREN = 7;
  ...
  // condition SRCXSIZE > DESTXSIZE
  // CH_XSIZE = 32'H 0005_0010
  topEnvConfigHandle.allChannelConfig[0][1].CH_XSIZE = 'h 0005_0010;
...
task dma1dBlockTransferWithContinueSrcGreaterThanDesXsizeAndHwTiAndHiTo::run_phase(uvm_phase phase);
