`ifndef DMA1D_BLOCK_TRANSFER_WITH_FILL_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED
`define DMA1D_BLOCK_TRANSFER_WITH_FILL_SRC_AND_DEST_XSIZE_EQ_AND_HWTI_HITO_INCLUDED

class dma1dBlockTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo extends dmaBaseTest;
  `uvm_component_utils(dma1dBlockTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo);
  dma1DVirtualSeq dma1DVirtualSeqHandle;
  extern function new(string name ="dma1dBlockTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
...
function dma1dBlockTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo :: new(string name ="dma1dBlockTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo",uvm_component parent = null);
  super.new(name,parent);
endfunction


function void dma1dBlockTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo::build_phase(uvm_phase phase);
  ...
  topEnvConfigHandle.allChannelConfig[0][0].CH_XSIZE = 'h 00050005;
...
task dma1dBlockTransferWithFillSrcAndDesXsizeEqAndHwTiAndHiTo::run_phase(uvm_phase phase);
