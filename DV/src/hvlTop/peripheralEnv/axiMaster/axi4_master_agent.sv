...
function void axi4_master_agent::build_phase(uvm_phase phase);
  ...
  if(!(uvm_config_db #(axi4_master_agent_config) :: get(this,"",$sformatf("axi4MasterAgentConfigHandle[%0d]",masterId), axi4_master_agent_cfg_h))) begin 
    `uvm_fatal("AXI MASTER AGENT","FAILED TO GET THE MASTER AGENT CONFIG")
  end  
