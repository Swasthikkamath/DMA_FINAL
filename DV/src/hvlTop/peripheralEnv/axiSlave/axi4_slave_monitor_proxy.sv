...
function void axi4_slave_monitor_proxy::build_phase(uvm_phase phase);
  ...
  axi4_slave_mon_bfm_h = axi4_slave_agent_cfg_h.axi4SlaveMonitorBfm;
...
task axi4_slave_monitor_proxy::axi4_slave_write_address();
  forever begin
    ...
    `uvm_info(get_type_name(),$sformatf("Packet received from axi4_slave_write_address_sampling is %s",req_wr_clone_packet.sprint()),UVM_DEBUG)
