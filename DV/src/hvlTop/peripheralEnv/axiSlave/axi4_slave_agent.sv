...
function void axi4_slave_agent::build_phase(uvm_phase phase);
  super.build_phase(phase);
   if(!(uvm_config_db #(axi4_slave_agent_config) :: get(this,"",$sformatf("axi4SlaveAgentConfigHandle[%0d]",slaveId), axi4_slave_agent_cfg_h))) begin 
    `uvm_fatal("AXI SLAVE AGENT","FAILED TO GET THE SLAVE AGENT CONFIG")
  end 
