...
class axi4_slave_memory extends uvm_object;
  ...
  protected static bit [7:0] slave_memory [longint];


  protected static bit[7:0] commandMemory[longint];
  ...
  extern static function void commandRead (input bit [ADDRESS_WIDTH-1:0]slave_address, output bit [7:0]data);
  extern static function void commandWrite(input bit [ADDRESS_WIDTH-1:0]slave_address, bit [7:0]data);
