...
package axi4_globals_pkg;
  ...
  parameter int NO_OF_SLAVES = 4;  //THIS IS EQUIVALENT TO NO OF PERIPHERALS IS CONNECTED
  ...
  typedef enum bit[1:0] {
    NON_OUTSTANDING_WRITE      = 2'b00, 
    NON_OUTSTANDING_READ       = 2'b01, 
    OUTSTANDING_WRITE  = 2'b10, 
    OUTSTANDING_READ   = 2'b11 
  }transfer_type_e;
