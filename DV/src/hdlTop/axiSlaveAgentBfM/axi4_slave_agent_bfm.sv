...
*/
  ...
  //-------------------------------------------------------
   initial begin
    uvm_config_db#(virtual axi4_slave_driver_bfm)::set(null,"*",$sformatf("axi4SlaveDriverBfm[%0d]",SLAVE_ID), axi4_slave_drv_bfm_h); 
    uvm_config_db#(virtual axi4_slave_monitor_bfm)::set(null,"*",$sformatf("axi4SlaveMonitorBfm[%0d]",SLAVE_ID), axi4_slave_mon_bfm_h);
  end
