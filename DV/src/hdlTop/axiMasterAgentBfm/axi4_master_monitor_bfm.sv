...
interface axi4_master_monitor_bfm(input bit aclk, input bit aresetn,
  ...
  task axi4_write_address_sampling(output axi4_write_transfer_char_s req ,input axi4_transfer_cfg_s cfg);
    ...
    while(masterMonCb.awvalid!==1 || masterMonCb.awready!==1)begin
      @(masterMonCb);
      `uvm_info("FROM MASTER MON BFM",$sformatf("Inside while loop......"),UVM_DEBUG)
    end    
    `uvm_info("FROM MASTER MON BFM",$sformatf("after while loop ......."),UVM_DEBUG)
    ...
    `uvm_info("FROM MASTER MON BFM",$sformatf("datapacket =%p",req),UVM_DEBUG)
  endtask
  ...
  task axi4_write_data_sampling(output axi4_write_transfer_char_s req ,input axi4_transfer_cfg_s cfg);
    ...
    static int i = 0;
      ...
      `uvm_info("FROM MASTER MON BFM",$sformatf("After while loop write data......"),UVM_DEBUG)
      ...
      `uvm_info("FROM MASTER MON BFM write data",$sformatf("write datapacket wdata[%0d] = 'h%0x",i,req.wdata[i]),UVM_DEBUG)
      `uvm_info("FROM MASTER MON BFM write data",$sformatf("write datapacket wstrb[%0d] = 'h%0x",i,req.wstrb[i]),UVM_DEBUG)
  ...
  task axi4_write_response_sampling(output axi4_write_transfer_char_s req ,input axi4_transfer_cfg_s cfg);
    `uvm_info("FROM MASTER MON BFM",$sformatf("AFTER WHILE LOOP OF WRITE RESPONSE"),UVM_DEBUG)
